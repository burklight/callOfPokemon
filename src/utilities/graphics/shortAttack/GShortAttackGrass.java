...
/**
 * This class reads the picture of ShortAttackGrass and sets it.
 *
 */
public final class GShortAttackGrass extends GShortAttack {

    public GShortAttackGrass(ShortAttack a) {
        super(a);
        try {
            setImage(ImageIO.read(new File("attacks/shortGrass.png")));
            setImages();
        } catch (Exception ex) {
            ex.printStackTrace();
        }

...
/**
 * This class reads the picture of ShortAttackFire and sets it.
 *
 */
public final class GShortAttackFire extends GShortAttack {

    public GShortAttackFire(ShortAttack a) {
        super(a);
        try {
            setImage(ImageIO.read(new File("attacks/shortFire.png")));
            setImages();
        } catch (Exception ex) {
            ex.printStackTrace();
        }

...
/**
 * This class reads the picture of ShortAttackMagicSlash and sets it.
 *
 */
public final class GShortAttackMagicSlash extends GShortAttack {

    public GShortAttackMagicSlash(ShortAttack a) {
        super(a);
        try {
            setImage(ImageIO.read(new File("attacks/shortMagicSlash.png")));
            setImages();
        } catch (Exception ex) {
            ex.printStackTrace();
        }

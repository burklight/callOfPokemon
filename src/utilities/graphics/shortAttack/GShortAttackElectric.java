...
/**
 * This class reads the picture of ShortAttackElectric and sets it.
 *
 */
public final class GShortAttackElectric extends GShortAttack {

    public GShortAttackElectric(ShortAttack a) {
        super(a);
        try {
            setImage(ImageIO.read(new File("attacks/shortElectric.png")));
            setImages();
        } catch (Exception ex) {
            ex.printStackTrace();
        }

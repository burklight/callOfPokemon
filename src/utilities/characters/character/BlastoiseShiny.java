...
import utilities.graphics.character.GBlastoiseShiny;
import utilities.map.OurMap;
import utilities.communications.Comms;

/**
 * Class that defines BlastoiseShiny's qualities.
 *
 */
public class BlastoiseShiny extends OurCharacter {

    public BlastoiseShiny(OurMap m) throws Exception {
        super(m);
    ...
    public GCharacter getGraphics() {
        return new GBlastoiseShiny(this);
    }

...
import utilities.graphics.character.GBulbasurShiny;
...
/**
 * Class that defines BulbasurShiny's qualities.
 *
 */
public class BulbasurShiny extends OurCharacter {

    public BulbasurShiny(OurMap m) throws Exception {
        super(m);
        name = "Bulbasur shiny";
        type = Comms.grass;
        maxLife = 100;
    ...
    public GCharacter getGraphics() {
        return new GBulbasurShiny(this);
    }

...
import utilities.graphics.character.GPikachuShiny;
import utilities.map.OurMap;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * Class that defines PikachuShiny's qualities.
 *
 */
public class PikachuShiny extends OurCharacter {

    public PikachuShiny(OurMap m) throws Exception {
        super(m);
        name = "Pikachu shiny";
        type = Comms.electric;
        maxLife = 100;

...
import utilities.graphics.character.GCharizard;
import utilities.map.OurMap;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * Class that defines Charizard's qualities.
 *
 */
public class Charizard extends OurCharacter {

    public Charizard(OurMap m) throws Exception {
        super(m);
        name = "Charizard";
        type = Comms.fire;
        maxLife = 500;

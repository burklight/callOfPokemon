...
import utilities.graphics.character.GCharmanderShiny;
import utilities.map.OurMap;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * Class that defines CharmanderShiny's qualities.
 *
 */
public class CharmanderShiny extends OurCharacter {

    public CharmanderShiny(OurMap m) throws Exception {
        super(m);
    ...
    public GCharacter getGraphics() {
        return new GCharmanderShiny(this);
    }

...
import utilities.graphics.character.GRaichuShiny;
import utilities.map.OurMap;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * Class that defines RaichuShiny's qualities.
 *
 */
public class RaichuShiny extends OurCharacter {

    public RaichuShiny(OurMap m) throws Exception {
        super(m);
        name = "Raichu shiny";
        type = Comms.electric;
        maxLife = 500;

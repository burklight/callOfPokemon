...
import utilities.graphics.character.GVenusaurShiny;
import utilities.map.OurMap;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * Class that defines VenusaurShiny's qualities.
 *
 */
public class VenusaurShiny extends OurCharacter {

    public VenusaurShiny(OurMap m) throws Exception {
        super(m);
        name = "Venusaur shiny";
        type = Comms.grass;
        maxLife = 500;
    ...
    public GCharacter getGraphics() {
        return new GVenusaurShiny(this);
    }

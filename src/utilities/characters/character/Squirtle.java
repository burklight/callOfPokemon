...
import utilities.graphics.character.GSquirtle;
import utilities.map.OurMap;
import utilities.communications.Comms;

/**
 * Class that defines Squirtle's qualities.
 *
 */
public class Squirtle extends OurCharacter {

    public Squirtle(OurMap m) throws Exception {
        super(m);
        name = "Squirtle";
        type = Comms.water;
        maxLife = 100;

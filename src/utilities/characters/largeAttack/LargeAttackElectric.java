...
import utilities.graphics.largeAttack.GLargeAttackElectric;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackElectric's qualities.
 *
 */
public class LargeAttackElectric extends LargeAttack {

    public LargeAttackElectric(OurCharacter c) {
        super(c);
        type = Comms.electric;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackElectric(this);
    }

...
import utilities.graphics.largeAttack.GLargeAttackShadow;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackShadow's qualities.
 *
 */
public class LargeAttackShadow extends LargeAttack {

    public LargeAttackShadow(OurCharacter c) {
        super(c);
        type = Comms.neutral;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackShadow(this);
    }

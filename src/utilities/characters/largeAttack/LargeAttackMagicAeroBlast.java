...
import utilities.graphics.largeAttack.GLargeAttackMagicAeroBlast;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackMagicAeroBlast's qualities.
 *
 */
public class LargeAttackMagicAeroBlast extends LargeAttack {

    public LargeAttackMagicAeroBlast(OurCharacter c) {
        super(c);
        type = Comms.magic;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackMagicAeroBlast(this);
    }

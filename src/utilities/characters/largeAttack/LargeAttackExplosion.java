...
import utilities.graphics.largeAttack.GLargeAttackExplosion;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackExplosion's qualities.
 *
 */
public class LargeAttackExplosion extends LargeAttack {

    public LargeAttackExplosion(OurCharacter c) {
        super(c);
        type = Comms.magic;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackExplosion(this);
    }

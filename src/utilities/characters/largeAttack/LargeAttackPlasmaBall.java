...
import utilities.graphics.largeAttack.GLargeAttackPlasmaBall;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackPlasmaBall's qualities.
 *
 */
public class LargeAttackPlasmaBall extends LargeAttack {

    public LargeAttackPlasmaBall(OurCharacter c) {
        super(c);
        type = Comms.esper;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackPlasmaBall(this);
    }

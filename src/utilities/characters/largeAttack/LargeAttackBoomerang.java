...
import utilities.graphics.largeAttack.GLargeAttackBoomerang;
import utilities.communications.Comms;
import utilities.graphics.Coordinate;

/**
 * This class defines LargeAttackBoomerang's qualities.
 *
 */
public class LargeAttackBoomerang extends LargeAttack {

    public LargeAttackBoomerang(OurCharacter c) {
        super(c);
        type = Comms.neutral;
    }
    ...
    public GLargeAttack getGraphics() {
        return new GLargeAttackBoomerang(this);
    }

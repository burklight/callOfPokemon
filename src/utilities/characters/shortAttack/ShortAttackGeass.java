...
import utilities.graphics.shortAttack.GShortAttackGeass;

/**
 * This class defines ShortAttackGeass's qualities.
 *
 */
public class ShortAttackGeass extends ShortAttack {

    public ShortAttackGeass(OurCharacter c) {
        super(c);
        type = Comms.neutral;
        loopsActive = 10;
    }
    ...
    public GShortAttack getGraphics() {
        return new GShortAttackGeass(this);
    }

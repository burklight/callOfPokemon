...
import utilities.graphics.shortAttack.GShortAttackFire;

/**
 * This class defines ShortAttackFire's qualities.
 *
 */
public class ShortAttackFire extends ShortAttack {

    public ShortAttackFire(OurCharacter c) {
        super(c);
        type = Comms.fire;
        loopsActive = 10;
    }
    ...
    public GShortAttack getGraphics() {
        return new GShortAttackFire(this);
    }

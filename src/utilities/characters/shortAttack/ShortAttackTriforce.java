...
import utilities.graphics.shortAttack.GShortAttackTriforce;

/**
 * This class defines ShortAttackTriforce's qualities.
 *
 */
public class ShortAttackTriforce extends ShortAttack {

    public ShortAttackTriforce(OurCharacter c) {
        super(c);
        type = Comms.neutral;
        loopsActive = 10;
    }
    ...
    public GShortAttack getGraphics() {
        return new GShortAttackTriforce(this);
    }

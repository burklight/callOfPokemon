...
import utilities.graphics.shortAttack.GShortAttackAirSlash;

/**
 * This class defines ShortAttackAirSlash's qualities.
 *
 */
public class ShortAttackAirSlash extends ShortAttack {

    public ShortAttackAirSlash(OurCharacter c) {
        super(c);
        type = Comms.esper;
        loopsActive = 10;
    }
    ...
    public GShortAttack getGraphics() {
        return new GShortAttackAirSlash(this);
    }
